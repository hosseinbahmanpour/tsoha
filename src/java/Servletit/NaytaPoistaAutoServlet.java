...
public class NaytaPoistaAutoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (kirjautunut == null) {
            ...
            tms.naytaJSP("poistaauto.jsp", request, response);
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(NaytaPoistaAutoServlet.class.getName()).log(Level.SEVERE, null, ex);
